		...
		<Box as="section" id="about" className="section">
			...
			<Flex direction="column" gap={3} pt={10} pb={16} maxW="5xl">
				<Text fontSize="xl">
					...
					programming journey as Wordpress developer. Now I'm in love with React and Next.js. In the
					future I see myself learning React Native or Flutter, because of my big interest in these
					technologies.
				</Text>
				<Text fontSize="xl">
